...
function init() {
    ...
    var table = document.getElementById("aqi-table");
    //var arrBtnDel = table.getElementsByClassName("del-btn");  //明白了，这句话只在js加载时执行一次，所以arrBtnDel没有绑定button
    table.addEventListener("click", function(e) {       //为啥要在table绑定而不能直接绑定在arrBtnDel上
